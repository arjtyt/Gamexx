...
/* JADX INFO: compiled from: SetTagOperation.kt */
...
public final class SetTagOperation extends Operation {
    ...
    private final void setKey(String value) throws Throwable {
    ...
    public SetTagOperation(String appId, String onesignalId, String key, String value) throws Throwable {
        this();
