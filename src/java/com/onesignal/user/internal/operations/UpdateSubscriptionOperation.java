...
public final class UpdateSubscriptionOperation extends Operation {
    ...
    public final SubscriptionType getType() {
        UpdateSubscriptionOperation this_$iv = this;
    ...
    private final void setType(SubscriptionType value) throws Throwable {
        UpdateSubscriptionOperation this_$iv$iv = this;
    ...
    public UpdateSubscriptionOperation(String appId, String onesignalId, String subscriptionId, SubscriptionType type, boolean enabled, String address, SubscriptionStatus status) throws Throwable {
        this();
